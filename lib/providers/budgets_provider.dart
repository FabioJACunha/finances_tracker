...
final budgetSpentProvider = StreamProvider.autoDispose.family<double, Budget>(
    ...
    await for (final transactions in transactionsStream) {
      ...
      final totalSpent = transactions.where((t) => t.type == TransactionType.expense).fold(
...
final budgetCategoriesProvider = StreamProvider.autoDispose.family<List<Category>, int>((ref, budgetId) async* {
